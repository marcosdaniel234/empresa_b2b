  ...
  return (
    <div>
      ...
      >
        {TABS.map((t) => (
          <button
            ...
            className={`-mb-px border-b-2 min-h-11 px-1 pb-3 text-label font-medium ${
              tab === t.key
      ...
      <div className="mt-6">
        {filtered.length === 0 ? (
          <EmptyState
            title="Nenhum leilão nesta categoria."
            description="Veja as outras abas para os demais leilões desta empresa."
          />
        ) : (
