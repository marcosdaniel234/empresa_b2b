          ...
          {states.map((state) => (
            <li key={state.uf}>
              ...
              >
                <span
                  aria-hidden="true"
                  className="inline-flex h-5 items-center rounded-[2px] bg-brand-900 px-1.5 text-micro font-bold text-white transition-colors duration-standard group-hover:bg-action"
                >
                  {state.uf}
                </span>
                {state.name}
