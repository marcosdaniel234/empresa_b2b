...
export const SUBCATEGORIES: Record<Category, Subcategory[]> = {
  ...
  veiculos: [
    ...
    { slug: "motonautica", label: "Motos aquáticas" },
    { slug: "quadriciclos", label: "Quadriciclos" },
  ],
  tecnologia: [
...
export const ASSETS: Asset[] = [
  ...
  },
  {
    id: "a33",
    modalidade: "venda_direta",
    subcategory: "motonautica",
    lot: "LT-1224",
    slug: "sea-doo-wake-pro-230-2026",
    title: "Sea-Doo Wake Pro 230 2026",
    category: "veiculos",
    companySlug: "portomar-industria",
    city: "Vitória",
    state: "ES",
    ...
    specs: [
      ...
      { label: "Modelo", value: "Wake Pro 230" },
      { label: "Potência", value: "230 cv" },
      { label: "Motor", value: "Rotax 1630 ACE" },
      { label: "Capacidade", value: "3 passageiros" },
      { label: "Tanque", value: "70 L" },
    ],
    condition:
      "Unidade nova de demonstração, ano-modelo 2026. Disponibilidade, configuração final e condições comerciais devem ser confirmadas com o anunciante.",
    description:
      "Moto aquática Sea-Doo para esportes a reboque, com casco ST3, Ski Mode, mastro retrátil LinQ e suporte para prancha. Preço de referência do fabricante para o modelo de entrada.",
    documents: ["Ficha técnica do fabricante", "Termos de garantia BRP"],
    pickup:
      "Entrega ou retirada mediante agendamento em Vitória/ES; frete e preparação são confirmados na proposta comercial.",
    gallery: 1,
  },
  {
    id: "a34",
    ...
    subcategory: "motonautica",
    lot: "LT-1226",
    slug: "sea-doo-gtx-170-2026",
    title: "Sea-Doo GTX 170 2026",
    category: "veiculos",
    companySlug: "portomar-industria",
    city: "Vitória",
    state: "ES",
    ...
    specs: [
      { label: "Ano/modelo", value: "2026/2026" },
      { label: "Modelo", value: "GTX 170" },
      { label: "Potência", value: "170 cv" },
      { label: "Motor", value: "Rotax 1630 ACE" },
      { label: "Capacidade", value: "3 passageiros" },
      { label: "Armazenamento", value: "98,9 L" },
    ],
    condition:
      "Unidade nova de demonstração, ano-modelo 2026. Disponibilidade, configuração final e condições comerciais devem ser confirmadas com o anunciante.",
    description:
      "Moto aquática Sea-Doo de turismo com plataforma de popa ampla, casco em fibra de vidro, sistema iDF e pontos de fixação LinQ. Preço de referência do fabricante para o modelo de entrada.",
    documents: ["Ficha técnica do fabricante", "Termos de garantia BRP"],
    pickup:
      "Entrega ou retirada mediante agendamento em Vitória/ES; frete e preparação são confirmados na proposta comercial.",
    gallery: 1,
  },
  {
    id: "a35",
    modalidade: "venda_direta",
    subcategory: "quadriciclos",
    lot: "LT-1228",
    slug: "can-am-outlander-max-xt-700-2026",
    title: "Can-Am Outlander MAX XT 700 2026",
    category: "veiculos",
    companySlug: "agroverde-maquinas",
    city: "Ribeirão Preto",
    state: "SP",
    ...
    specs: [
      { label: "Ano/modelo", value: "2026/2026" },
      { label: "Modelo", value: "Outlander MAX XT 700" },
      { label: "Potência", value: "50 cv" },
      { label: "Motor", value: "ACE 650 cc" },
      { label: "Tração", value: "2WD / 4WD selecionável" },
      { label: "Pneus", value: "XPS Trail Force 26 pol." },
    ],
    condition:
      "Unidade nova de demonstração, ano-modelo 2026. Disponibilidade, configuração final e condições comerciais devem ser confirmadas com o anunciante.",
    description:
      "Quadriciclo Can-Am de dois lugares com direção assistida, modos de pilotagem, rodas de alumínio de 14 polegadas e guincho para 1.588 kg. Preço de referência do fabricante.",
    documents: ["Ficha técnica do fabricante", "Termos de garantia BRP"],
    pickup:
      "Entrega ou retirada mediante agendamento em Ribeirão Preto/SP; frete e preparação são confirmados na proposta comercial.",
    gallery: 1,
  },
  {
    id: "a36",
    ...
    subcategory: "quadriciclos",
    lot: "LT-1230",
    slug: "can-am-renegade-xmr-1000r-2026",
    title: "Can-Am Renegade X mr 1000R 2026",
    category: "veiculos",
    companySlug: "agroverde-maquinas",
    city: "Ribeirão Preto",
    state: "SP",
    ...
    specs: [
      { label: "Ano/modelo", value: "2026/2026" },
      { label: "Modelo", value: "Renegade X mr 1000R" },
      { label: "Potência", value: "91 cv" },
      { label: "Transmissão", value: "CVT com reduzida" },
      { label: "Tração", value: "Visco-4Lok" },
      { label: "Pneus", value: "ITP Cryptid 30 pol." },
    ],
    condition:
      "Unidade nova de demonstração, ano-modelo 2026. Disponibilidade, configuração final e condições comerciais devem ser confirmadas com o anunciante.",
    description:
      "Quadriciclo esportivo Can-Am preparado para lama, com diferencial dianteiro Visco-4Lok, pneus de 30 polegadas, rodas beadlock e guincho de 1.588 kg. Preço de referência do fabricante.",
    documents: ["Ficha técnica do fabricante", "Termos de garantia BRP"],
    pickup:
      "Entrega ou retirada mediante agendamento em Ribeirão Preto/SP; frete e preparação são confirmados na proposta comercial.",
    gallery: 1,
